        ...
        <div className="justify-center flex flex-col gap-3 md:gap-6 lg:max-w-screen-sm pr-4">
          ...
          <div className="flex gap-2 xs:gap-2 md:gap-8 w-full justify-center md:justify-start">
            <article className="flex flex-col w-20 md:w-24 items-center gap-2">
              ...
              <p className="font-tajawal text-xs sm:text-sm text-center">Ofertas por tiempo limitado</p>
            </article>
            <article className="flex flex-col w-20 md:w-24 items-center gap-2">
              <span className="h-20 w-20 md:h-24 md:w-24 border-4 border-slate-300 bg-arle-blue rounded-full flex items-center justify-center p-4 md:p-6">
              ...
              <p className="font-tajawal text-xs sm:text-sm text-center">Envíos Gratis siempre</p>
            </article>
            <article className="flex flex-col w-20 md:w-24 items-center gap-2">
              <span className="h-20 w-20 md:h-24 md:w-24 border-4 border-slate-300 bg-arle-blue rounded-full flex items-center justify-center p-4 md:p-6">
              ...
              <p className="font-tajawal text-xs sm:text-sm text-center">Productos Hasta 50% OFF</p>
            </article>
            <article className="flex flex-col w-20 md:w-24 items-center gap-2">
              <span className="h-20 w-20 md:h-24 md:w-24 border-4 border-slate-300 bg-arle-blue rounded-full flex items-center justify-center p-4 md:p-6">
              ...
              <p className="font-tajawal text-xs sm:text-sm text-center">Descuentos Exclusivos</p>
            </article>
          </div>
        </div>
      </section>
