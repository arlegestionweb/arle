    ...
    <section className=" max-w-screen h-[70vh] relative">
      <GradientImage
        ...
        <div className="sticky z-10 self-stretch h-[114px] flex-col justify-center items-center gap-2.5 flex">
          <h2 className="self-stretch  text-center text-white text-[32px] font-semibold leading-[38.40px]">
            {titulo}
          </h2>
          <p className="text-center text-white text-2xl font-semibold leading-[28.80px]">{descripcion}</p>
          <Link href={`/listing?type=${typeParamFromTitle(titulo.toLowerCase().trim())}`}>
